...
<header class="py-3 container">
    <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
        <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
            ...
            <span class="fs-4">User balance</span>
        </a>

        <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
            <a class="me-3 py-2
                    @if(URL::current() == route('main')) text-blue-50 @else text-dark @endif
                text-decoration-none" href="{{route('main')}}">Главная</a>

            <a class="me-3 py-2
                    @if(URL::current() == route('balance-history')) text-blue-50 @else text-dark @endif
                text-decoration-none" href="{{route('balance-history')}}">История операции</a>
